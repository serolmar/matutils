...
namespace Utilities
{
    ...
    /// <summary>
    /// Enumerador para a posição dos bits que estão activos num longo sem sinal.
    /// </summary>
    public class BitScanEnumerable : IEnumerable<int>
    {
        /// <summary>
        /// Mantém o valor cujos bits activos são enumerados.
        /// </summary>
        private ulong value;

        /// <summary>
        /// Instancia uma nova instância de objectos do tipo <see cref="BitScanEnumerable"/>.
        /// </summary>
        /// <param name="value"></param>
        public BitScanEnumerable(ulong value)
        {
            this.value = value;
        }

        /// <summary>
        /// Obtém o valor cujos bits activos são enumerados.
        /// </summary>
        public ulong Value
        {
            get
        ...
        {
            return new BitScanEnumerator(this.value);
        }
        ...
        /// <summary>
        /// O enumerador para o iterador sobre bits activos de um longo sem sinal.
        /// </summary>
        private class BitScanEnumerator : IEnumerator<int>
        {
            /// <summary>
            /// Valores usados no processo de enumeração.
            /// </summary>
            private readonly int[] bitValues =
                {
            ...
            /// <summary>
            /// Valor usado no processo de enumeração.
            /// </summary>
            private readonly ulong auxiliary = 0x03f79d71b4cb0a89;
            ...
            /// <summary>
            /// Mantém a referência da qual se poderá obter o valor actual.
            /// </summary>
            private ulong current;

            /// <summary>
            /// Valor que indica se o iterador foi iniciado.
            /// </summary>
            private bool started;

            /// <summary>
            /// Valor que indica se o iterador foi finalizado.
            /// </summary>
            private bool ended;

            /// <summary>
            /// Valor que indica se o iterador foi eliminado.
            /// </summary>
            private bool disposed;

            /// <summary>
            /// Instancia numa nova instância de objectos do tipo <see cref="BitScanEnumerator"/>.
            /// </summary>
            /// <param name="value"></param>
            public BitScanEnumerator(ulong value)
            {
                this.value = value;
                this.current = value;
                this.started = false;
            ...
            public int Current
            {
                get
                {
                    ...
                    {
                        throw new InvalidOperationException("Enumeratoration not started.");
                    }
                    else if (this.ended)
                    {
                        throw new InvalidOperationException("Enumeration already ended");
                    }
                    else
                    {
                        var mask = this.current - 1;
                        return this.bitValues[((this.current ^ mask) * this.auxiliary) >> 58];
                    }
                }
            }
            ...
            /// </summary>
            /// <returns>Verdadeiro caso seja possível mover.</returns>
