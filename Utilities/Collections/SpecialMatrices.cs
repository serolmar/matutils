namespace Utilities
{
    ...
    public class SubMatrix<ObjectType> : IMatrix<ObjectType>
    {
        ...
        {
            throw new UtilitiesException("Can't swap submatrix lines.");
        }
        ...
        {
            throw new UtilitiesException("Can't swap submatrix columns.");
        }
    ...
    /// </summary>
    /// <typeparam name="ObjectType">O tipo de elementos na matriz.</typeparam>
    public class SubMatrixLong<ObjectType> : ILongMatrix<ObjectType>
    {
        /// <summary>
        /// A matriz original.
        /// </summary>
        private ILongMatrix<ObjectType> matrix;
        ...
        /// <summary>
        /// Instancia um novo objecto do tipo <see cref="SubMatrixLong{ObjectType}"/>.
        /// </summary>
        /// <param name="matrix">A matriz original.</param>
        /// <param name="lines">As linhas que constituem a sub-matriz.</param>
        /// <param name="columns">As colunas que constituem a sub-matriz.</param>
        ...
        /// Se as linhas ou as colunas forem vectores nulos.
        /// </exception>
        public SubMatrixLong(ILongMatrix<ObjectType> matrix, long[] lines, long[] columns)
        {
            if (lines == null || columns == null)
            {
                throw new ArgumentException("Parameters lines and columns must be non null.");
            ...
            {
                this.matrix = matrix;
                this.lines = new long[lines.Length];
                Array.Copy(lines, this.lines, lines.Length);
                this.columns = new long[columns.Length];
                Array.Copy(columns, this.columns, columns.Length);
            }
        }
    ...
    public class IntegerSequenceSubMatrix<ObjectType> : ILongMatrix<ObjectType>
    {
        /// <summary>
        /// A matriz.
        /// </summary>
        ...
        public ObjectType this[long line, long column]
        {
            get
            {
                ...
                {
                    return this.matrix[this.lines[(int)line], this.columns[(int)column]];
                }
            }
            set
            {
                ...
                {
                    this.matrix[this.lines[(int)line], this.columns[(int)column]] = value;
                }
            }
        }
    ...
    /// </remarks>
    /// <typeparam name="ObjectType">O tipo dos objectos que constituem as entradas da matriz.</typeparam>
    public class LongIntegerSequenceSubMatrix<ObjectType> : ILongMatrix<ObjectType>
    {
        /// <summary>
        /// A matriz.
        /// </summary>
        ...
        /// O número de linhas.
        /// </summary>
        private LongIntegerSequence lines;

        /// <summary>
        /// O número de colunas.
        /// </summary>
        private LongIntegerSequence columns;

        /// <summary>
        /// Cria instâncias de objectos do tipo <see cref="LongIntegerSequenceSubMatrix{ObjectType}"/>.
        /// </summary>
        /// <param name="matrix">A matriz principal.</param>
        /// <param name="lines">As linhas da matriz que pertencem à sub-matriz.</param>
        /// <param name="columns">As colunas da matriz que pertencem à sub-matriz.</param>
        public LongIntegerSequenceSubMatrix(
            ILongMatrix<ObjectType> matrix, 
            LongIntegerSequence lines, 
            LongIntegerSequence columns)
        {
            if (lines == null || columns == null)
            {
                throw new ArgumentException("Parameters lines and columns must be non null.");
    ...
    /// </summary>
    /// <typeparam name="ObjectType">O tipo dos objectos que constituem as entradas das matrizes.</typeparam>
    public class LongTransposedMatrix<ObjectType> : ILongMatrix<ObjectType>
    { 
        /// <summary>
        /// A matriz original.
        /// </summary>
        ...
        /// <summary>
        /// Instancia um novo objecto do tipo <see cref="LongTransposedMatrix{ObjectType}"/>.
        /// </summary>
        /// <param name="matrix">A matriz.</param>
        /// <exception cref="ArgumentNullException">Se a matriz for nula.</exception>
        public LongTransposedMatrix(ILongMatrix<ObjectType> matrix)
        {
            if (matrix == null)
            {
                throw new ArgumentNullException("matrix");
        ...
        public long GetLongLength(int dimension)
        {
            if (dimension == 0)
            {
                return this.matrix.GetLongLength(1);
            }
            else if (dimension == 1)
            {
                return this.matrix.GetLongLength(0);
            }
            else
            {
                throw new ArgumentException("Parameter dimension can only take the values 0 or 1.");
