namespace Mathematics
{
    ...
    public class TransposeMatrix<ObjectType> : IMatrix<ObjectType>
    {
        ...
        /// <exception cref="NotSupportedException">A operação não é suportada em matrizes transpostas.</exception>
        public void ScalarLineMultiplication(int line, ObjectType scalar, IRing<ObjectType> ring)
        {
            throw new NotSupportedException("Line scalar multiplication isn't supported in transposed matrices.");
        }
        ...
        {
            throw new NotSupportedException("Lines combination isn't supported in transposed matrices.");
        }
