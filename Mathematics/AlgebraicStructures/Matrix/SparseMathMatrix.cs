namespace Mathematics
{
    ...
    public class CoordinateSparseMathMatrix<CoeffType>
        : SparseCoordinateMatrix<CoeffType>, ISparseMathMatrix<CoeffType>
    {
        /// <summary>
        ...
        public CoordinateSparseMathMatrix(int lines, int columns)
            : base(lines, columns) { }
        ...
        public CoordinateSparseMathMatrix(int lines, int columns, CoeffType defaultValue)
