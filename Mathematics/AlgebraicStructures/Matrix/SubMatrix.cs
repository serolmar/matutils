...
namespace Mathematics
{
    ...
    internal class SubMatrix<ObjectType> : IMatrix<ObjectType>
    {
        ...
        {
            throw new NotSupportedException("Line scalar multiplication isn't supported for submatrices.");
        }
        ...
        {
            throw new NotSupportedException("Lines combination isn't supported for submatrices.");
        }
